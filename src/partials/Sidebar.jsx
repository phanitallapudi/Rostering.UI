  ...
  return (
    ...
    <div>
      ...
      <div
        ...
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:sidebar-expanded:!w-64  shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-64'
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <ul className="mt-3 ml-1 flex flex-col justify-center items-start">
              ...
              <div>
                <button onClick={logoutHandler} className='hover:bg-gray-700  py-3 w-44 rounded-md text-white flex items-center justify-start'>

                  <span className='px-2 ml-[3px]'>
        ...
        <div className="pt-3 justify-end mt-3">
